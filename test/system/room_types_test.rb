...
class RoomTypesTest < ApplicationSystemTestCase
  ...
  test "should create room type" do
    ...
    fill_in "Capacity", with: @room_type.capacity
    fill_in "Extra info", with: @room_type.extra_info
    fill_in "Features", with: @room_type.features
    fill_in "Name", with: @room_type.name
    fill_in "Price", with: @room_type.price
    fill_in "Room", with: @room_type.room_id
