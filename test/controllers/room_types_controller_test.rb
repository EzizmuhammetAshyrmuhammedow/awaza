...
class RoomTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create room_type" do
    assert_difference("RoomType.count") do
      post room_types_url, params: { room_type: { capacity: @room_type.capacity, extra_info: @room_type.extra_info, features: @room_type.features, name: @room_type.name, price: @room_type.price, room_id: @room_type.room_id } }
    end
  ...
  test "should update room_type" do
    patch room_type_url(@room_type), params: { room_type: { capacity: @room_type.capacity, extra_info: @room_type.extra_info, features: @room_type.features, name: @room_type.name, price: @room_type.price, room_id: @room_type.room_id } }
