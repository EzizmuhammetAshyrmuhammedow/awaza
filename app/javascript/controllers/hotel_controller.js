...
export default class extends Controller {
    static targets = ["checkIn", "checkOut", "guestCount", "roomCount", "adults", "children", "rooms", "popover", "guests"];
        ...
        flatpickr("#daterange", {
            ...
            onClose: (selectedDates) => {
                if (selectedDates.length === 2) {
                    this.checkInTarget.value = selectedDates[0].toISOString().split("T")[0];
                    this.checkOutTarget.value = selectedDates[1].toISOString().split("T")[0];
                }
            },
        });
    }
