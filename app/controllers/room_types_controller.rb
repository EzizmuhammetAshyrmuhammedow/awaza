class RoomTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @room_type.save
        format.html { redirect_to hotel_room_type_path(@hotel.id, @room_type.id), notice: "Room type was successfully created." }
  ...
  def update
    respond_to do |format|
      if @room_type.update(room_type_params)
        format.html { redirect_to hotel_room_type_path(@hotel.id, @room_type.id), notice: "Room type was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to hotel_room_types_path, status: :see_other, notice: "Room type was successfully destroyed." }
